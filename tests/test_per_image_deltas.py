...
class TestRenderPerImageDeltas:
    ...
    def test_all_statuses_produce_status_badge(self) -> None:
        for status in ("improved", "regressed", "unchanged", "added", "removed"):
            deltas = [{"src": "x", "status": status, "bytes_delta": 0, "score_delta": 0,
                       "recommendation": ""}]
            html = _render_per_image_deltas(deltas)
    ...
    def test_long_src_is_truncated(self) -> None:
        ...
        deltas = [{"src": long_src, "status": "unchanged", "bytes_delta": 0,
                   "score_delta": 0, "recommendation": ""}]
        html = _render_per_image_deltas(deltas)
...
class TestComparisonSectionIntegration:
    def test_per_image_section_included_in_report(self) -> None:
        ...
        comp = {
            ...
            "vitals": {
                "lcp": {"before": 4200.0, "after": 1800.0, "delta": -2400.0,
                          "delta_pct": -57.14, "status": "improved"},
                "cls": {"before": 0.18, "after": 0.04, "delta": -0.14,
                          "delta_pct": -77.78, "status": "improved"},
                "inp": {"before": 320.0, "after": 180.0, "delta": -140.0,
                          "delta_pct": -43.75, "status": "improved"},
                "ttfb": {"before": 900.0, "after": 620.0, "delta": -280.0,
                           "delta_pct": -31.11, "status": "improved"},
            },
            "images": {
                "before_count": 3, "after_count": 3, "count_delta": 0,
                "before_total_bytes": 1_625_000, "after_total_bytes": 139_100,
                "total_bytes_delta": -1_485_900,
                "before_total_waste": 1_570_400, "after_total_waste": 84_500,
                "total_waste_delta": -1_485_900,
                "before_avg_score": 10.0, "after_avg_score": 57.0,
    ...
    def test_per_image_section_omitted_when_empty(self) -> None:
        ...
        comp = {
            ...
            "vitals": {
                "lcp": {"before": 1.0, "after": 1.0, "delta": 0.0,
                          "delta_pct": 0.0, "status": "unchanged"},
                "cls": {"before": 0.0, "after": 0.0, "delta": 0.0,
                          "delta_pct": None, "status": "unchanged"},
                "inp": {"before": 0.0, "after": 0.0, "delta": 0.0,
                          "delta_pct": None, "status": "unchanged"},
                "ttfb": {"before": 0.0, "after": 0.0, "delta": 0.0,
                           "delta_pct": None, "status": "unchanged"},
            },
            "images": {
                ...
                "total_bytes_delta": 0,
                "before_total_waste": 0, "after_total_waste": 0,
                "total_waste_delta": 0,
    ...
    def test_comparisonresult_model_input(self) -> None:
        ...
        comp = ComparisonResult.model_validate({
            ...
            "images": {
                "before_count": 1, "after_count": 1, "count_delta": 0,
                "before_total_bytes": 1000, "after_total_bytes": 1000,
                "total_bytes_delta": 0,
                "before_total_waste": 0, "after_total_waste": 0,
                "total_waste_delta": 0,
                "before_avg_score": 50.0, "after_avg_score": 50.0,
                "avg_score_delta": 0.0,
            },
            "summary": {
                "top_improvements": [],
