...
def audit_payload_with_comparison(audit_payload: dict) -> tuple[dict, dict]:
    ...
    comparison = {
        ...
        "images": {
            ...
            "before_total_bytes": 545000, "after_total_bytes": 545000, "total_bytes_delta": 0,
            "before_total_waste": 30000, "after_total_waste": 30000, "total_waste_delta": 0,
            "before_avg_score": 76.7, "after_avg_score": 76.7, "avg_score_delta": 0.0,
        },
        "summary": {
        ...
        "per_image": [
            {
                "match_key": "abc123",
                "src": "https://cdn.example.com/hero.jpg",
                "role_before": "hero", "role_after": "hero",
                ...
                "bytes_delta": -1080000,
                "score_delta": 0,
                "mime_before": "image/jpeg", "mime_after": "image/jpeg",
                "status": "improved",
            ...
            },
            {
                "match_key": "def456",
                "src": "https://cdn.example.com/thumb.png",
                "role_before": "decorative", "role_after": "decorative",
                ...
                "bytes_delta": 0,
                "score_delta": 0,
                "mime_before": "image/png", "mime_after": "image/png",
                "status": "unchanged",
                "recommendation": "",
            },
            {
                "match_key": "ghi789",
                "src": "https://cdn.example.com/product.jpg",
                "role_before": "product_primary", "role_after": None,
                "before": {"src": "https://cdn.example.com/product.jpg", "bytes": 380000, "mime": "image/jpeg"},
                "after": None,
                "bytes_delta": -380000,
                "score_delta": None,
                "mime_before": "image/jpeg", "mime_after": None,
                "status": "removed",
            ...
            },
            {
                ...
                "role_before": None, "role_after": "decorative",
                "before": None,
                "after": {"src": "https://cdn.example.com/new-thumb.webp", "bytes": 30000, "mime": "image/webp"},
                "bytes_delta": 30000,
                "score_delta": None,
                "mime_before": None, "mime_after": "image/webp",
                "status": "added",
...
class TestRenderComparisonSectionSnapshot:
    ...
    def test_with_comparison_data(
        self, snapshot, audit_payload_with_comparison: tuple[dict, dict]
    ) -> None:
...
class TestGenerateTrendHtmlSnapshot:
    ...
    def test_multi_entry_mixed_vitals(self, snapshot) -> None:
        entries = [
            _entry("2026-07-23T10:00:00Z", 4200.0, 0.18, 320.0, 900.0,
                   label="Baseline"),
            _entry("2026-07-30T15:00:00Z", 1800.0, 0.05, 100.0, 400.0,
    ...
    def test_multi_entry_poor_vitals(self, snapshot) -> None:
        entries = [
            _entry("2026-07-23T10:00:00Z", 5000.0, 0.30, 600.0, 2000.0,
                   label="Critical state"),
            _entry("2026-07-30T15:00:00Z", 3500.0, 0.20, 400.0, 1500.0,
                   label="After partial fix"),
        ]
        out = generate_trend_html("mystore.myshopify.com", entries)
        assert out == snapshot
